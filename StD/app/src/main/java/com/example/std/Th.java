...
public class Th extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
    private EditText ed;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.ad:
                ...
                Flhlp4.wrtdat(itm,this);
                Toast.makeText(Th.this, "Add", Toast.LENGTH_SHORT).show();
                break;
        }
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Toast.makeText(Th.this, "Deleted", Toast.LENGTH_SHORT).show();
    }
