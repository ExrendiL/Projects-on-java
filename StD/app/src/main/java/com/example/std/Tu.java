...
public class Tu extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
   ...
   public  void pre(){
       Intent intent= new Intent(this, Mo.class);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.ad:
                ...
                Flhlp2.wrtdat(itm,this);
                Toast.makeText(Tu.this, "Add", Toast.LENGTH_SHORT).show();
                break;
        }
    }
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Toast.makeText(Tu.this, "Deleted", Toast.LENGTH_SHORT).show();
    }
